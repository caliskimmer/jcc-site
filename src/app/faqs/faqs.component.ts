...
export class FaqsComponent implements OnInit {
  faqs: any[] = [{
    ...
    answer: 'Chiropractic care is a health care profession based on interactions of the spine and nervous system, as well as the surrounding muscles.'
  },
  {
    question: 'Are chiropractors doctors?',
    answer: 'Yes. Doctors of Chiropractic (also known as chiropractors) are not medical doctors, but go through a similar education process to become licensed in the field of chiropractic care. In fact, educational requirements for chiropractors are among the most stringent of any health care profession.'
  },
  {
  ...
  },
  {
    ...
    answer: 'The noises you hear resembling popping sounds are your joints releasing tiny pockets of air. A chiropractic adjustment does not affect the bones of either side of a joint; it affects the connective tissue that holds the joint together.'
  },
  {
    question: 'Are all patients adjusted the same way?',
    answer: 'Each patient’s care is unique and therefore customized to meet their specific condition and needs. Your chiropractor will modify adjustments based on your size, weight, age and health condition.'
  },
  {
    question: 'Will a chiropractic adjustment completely remove back pain?',
    answer: 'For many, back pain can become chronic if left untreated. Chiropractic care has been shown to ease and even eliminate back pain for many patients.'
  },
  {
    question: 'Can I see a chiropractor if I am pregnant?',
    answer: 'Many pregnant women find that chiropractic adjustments improve the pregnancy experience and make delivery easier. Adjustments are adapted to accommodate the stage of pregnancy and the unique needs of each patient.'
  },
  {
    question: 'Is back pain common?',
    answer: 'More than 80 percent of people experience lower back pain at some point in their lives. In fact, it is one of the most reported reasons people miss work and is the second most frequent reason patients visit the doctor.'
  },
  {
    question: 'Will I be required to remove my clothing at my appointment?',
    answer: 'Some procedures may require you to remove some pieces of clothing, however most do not. If you have any questions or concerns, bring them up immediately with your chiropractor.'
  },
  {
    question: 'Can I learn to adjust myself?',
    answer: 'Chiropractors are trained to adjust in a very specific location and direction. As a result, it is virtually impossible to adjust oneself correctly and accurately.'
  }];
