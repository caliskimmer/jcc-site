  ...
  faqs: any[] = [
    {
      ...
      answer:
        'Chiropractic care is a health care profession based on interactions of the spine ' +
        'and nervous system, as well as the surrounding muscles.',
    },
    {
      question: 'Are chiropractors doctors?',
      answer:
        'Yes. Doctors of Chiropractic (also known as chiropractors) are not medical doctors,' +
    ...
    },
    {
      ...
      answer:
        'Chiropractors are known for their expertise in caring for patients with back pain, neck pain,' +
    ...
    },
    {
      ...
      answer:
        'A chiropractic adjustment is the art of using a specific, controlled force in a precise direction that' +
    ...
    },
    {
      ...
      answer:
        'Chiropractic care is widely recognized as one of the safest drug-free, non-invasive ' +
    ...
    },
    {
      ...
      answer:
        'The noises you hear resembling popping sounds are your joints releasing tiny pockets of air.' +
    ...
    },
    {
      ...
      answer:
        'Each patient’s care is unique and therefore customized to meet their specific ' +
    ...
    },
    {
      ...
      answer:
        'For many, back pain can become chronic if left untreated. Chiropractic care has ' +
        'been shown to ease and even eliminate back pain for many patients.',
    },
    {
      question: 'Can I see a chiropractor if I am pregnant?',
      answer:
        'Many pregnant women find that chiropractic adjustments improve the pregnancy experience ' +
    ...
    },
    {
      ...
      answer:
        'More than 80 percent of people experience lower back pain at some point in their lives. ' +
    ...
    },
    {
      ...
      answer:
        'Some procedures may require you to remove some pieces of clothing, however most do not. ' +
    ...
    },
    {
      ...
      answer:
        'Chiropractors are trained to adjust in a very specific location and direction. ' +
